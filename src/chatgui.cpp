...
ChatBotPanelDialog::ChatBotPanelDialog(wxWindow *parent, wxWindowID id)
    : wxScrolledWindow(parent, id),
      _chatLogic(new ChatLogic())       // BO1 (either this or make_unique below)
{
    ...
    // _chatLogic = new ChatLogic();    // BO1
    // _chatLogic = std::make_unique<ChatLogic>();   // BO1 either this or in init list using new.
